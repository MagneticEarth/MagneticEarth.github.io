...
The magnetic field [vector components](https://intermagnet.org/faq/geomagnetic-comp.html) are observed over many years at fixed observatories (some going back to the 19th century) around the world.
The [INTERMAGNET organisation](https://intermagnet.org) sets standards and provides support to maintain a high quality global network of observatories.
...
The [SuperMAG collaboration](https://supermag.jhuapl.edu) is a recent initiative to collate and provide access to variometer data in a consistent manner.
